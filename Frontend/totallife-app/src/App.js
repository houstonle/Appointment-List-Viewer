...
const AppointmentList = () => {
  ...
  // Helper function to get the status label based on the status code
  ...
  return (
    <div className="container mx-auto mt-8 dark bg-gray-900 text-white rounded">
      ...
      {/* Filter Section */}
      <div className="flex mb-6 px-4 justify-between">
        {/* Date Inputs Section */}
        <div className="flex items-center">
          ...
          <div className="flex items-center ml-4 flex-shrink">
        ...
        <div className="flex items-center ml-4">
          <div className="flex justify-end">
            <button
              ...
              className="bg-blue-500 text-white px-4 py-2 rounded ml-4 hover:bg-blue-700"
            >
              Filter Appointments
            </button>
            <button
        ...
        {filteredAppointments.map((appointment) => (
          <li key={appointment.id} className="mb-6">
            <div className="border p-4 rounded-lg bg-gray-800 text-white">
              ...
              <p className="mb-2">Appointment Status: {getStatusLabel(appointment.appointment_status)}</p>
